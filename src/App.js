...
const AKME_GPT = () => {
  ...
  const [user, setUser] = useState({ name: 'Бережная Ника', avatar: '👩‍💼' });
  const [aiMessage, setAiMessage] = useState(''); // ← переместили сюда
          ...
          <div className="space-y-6">
            <div className="bg-gray-800 rounded-lg p-8 border border-gray-700 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-700 rounded-lg p-6">
                  <div className="w-12 h-12 bg-green-600 rounded-full flex items-center justify-center mx-auto mb-60">
